...
export const tailwindEffects: TailwindEffect[] = [
  {
    ...
    displayCodeLight: `<p class="animate-background-shine bg-[linear-gradient(110deg,var(--color-primary-50),45%,var(--color-primary-300),55%,var(--color-primary-50))] bg-[length:250%_100%] bg-clip-text text-transparent text-4xl font-bold text-center">
  ${textContent}
</p>`,
